...
try:
    ...
    class EnsembleResult:
        def __init__(self, consensus_genes, n_consensus_genes, ensemble_method, n_methods, method_names, direction_consistency=None, n_direction_inconsistent=0, method_statistics=None):
            self.consensus_genes = consensus_genes
            self.n_consensus_genes = n_consensus_genes
