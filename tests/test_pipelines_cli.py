...
# CLI currently only implements 'pipeline list' and 'pipeline run'.
# Individual pipeline subcommands (salmon, kallisto, etc.) are planned for v2.3.0.
CLI_PIPELINE_SUBCOMMANDS_IMPLEMENTED = False
...
class TestPipelineListCommand:
    ...
    @pytest.mark.skipif(not CLI_AVAILABLE or not CLICK_AVAILABLE,
                        reason="CLI or Click not available")
    @pytest.mark.skipif(not CLI_PIPELINE_SUBCOMMANDS_IMPLEMENTED, reason="CLI pipeline subcommands not yet implemented")
...
@pytest.mark.skipif(not CLI_PIPELINE_SUBCOMMANDS_IMPLEMENTED,
                    reason="CLI pipeline subcommands not yet implemented")
@pytest.mark.skipif(not CLI_AVAILABLE or not CLICK_AVAILABLE,
                    reason="CLI or Click not available")
