...
def render_sidebar():
    ...
    # Logo (if exists) - check both possible filenames
    images_dir = Path(__file__).parent.parent / "assets" / "images"
    logo_path = images_dir / "logo.png"
    if not logo_path.exists():
        logo_path = images_dir / "raptor_logo.png"
...
def init_session_state():
    ...
    if 'm7_de_results' not in st.session_state:
        st.session_state['m7_de_results'] = {}
