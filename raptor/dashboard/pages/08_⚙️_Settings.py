...
# Header
st.title("⚙️ RAPTOR Settings & Configuration")
...
if st.session_state.settings_modified:
    st.warning("⚠️ **You have unsaved changes.** Click 'Save Settings' above to persist your changes.")
else:
